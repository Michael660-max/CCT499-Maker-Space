 ...
 const handleEmailAuth = async (e) => {
   ...
   try {
     ...
     if (error.message.includes('Invalid login credentials')) {
       ...
       setMessage({ type: 'error', text: 'Please verify your email before signing in' });
       ...
       <div className="p-6 border-b border-gray-100">
         <div className="flex items-center justify-between mb-4">
           <h2 className="text-2xl font-bold text-gray-800 text-center w-full">
             {showVerificationNotice ? 'Check Your Email' : isSignUp ? 'Sign Up' : 'Sign In'}
           </h2>
         </div>
       ...
       {showVerificationNotice ? (
         <div className="p-6">
           <div className="text-center">
             ...
             <h3 className="text-lg font-semibold text-gray-800 mb-2 text-center">Verify Your Email</h3>
         ...
         <div className="p-6 space-y-4">
           ...
           <div className="space-y-3">
             ...
             <button
               onClick={() => setMessage({ type: 'info', text: 'Facebook login coming soon!' })}
           ...
           <div className="relative flex items-center py-4">
             ...
             <span className="flex-shrink mx-4 text-gray-500 text-sm text-center">or continue with email</span>
             <div className="flex-grow border-t border-gray-300"></div>
           </div>
