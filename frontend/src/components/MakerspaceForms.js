...
const MakerspaceForms = () => {
  ...
  const handleAddEquipment = () => {
    if (
      currentEquipment.trim() &&
      !makerspaceForm.equipment.includes(currentEquipment.trim())
    ) {
      setMakerspaceForm((prev) => ({
        ...prev,
              ...
              <form onSubmit={handleMakerspaceSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {Object.entries(makerspaceForm.hours).map(
                      ([day, hours]) => (
                        <div key={day} className="flex items-center space-x-3">
                          ...
                          <input
                            ...
                            value={hours}
                            onChange={(e) =>
                              handleHoursChange(day, e.target.value)
                            }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleMakerspaceChange("website", e.target.value)
                    }
              ...
              <form onSubmit={handleEventSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleEventChange("difficulty", e.target.value)
                    }
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-400 focus:border-transparent transition-all duration-200"
                  >
                    ...
                    <option value="intermediate" className="text-yellow-600">
                      Intermediate
                    </option>
                    <option value="advanced" className="text-red-600">
                      Advanced
                    </option>
                    <option value="all-levels" className="text-blue-600">
                      All Levels
                    </option>
                  </select>
                </div>
                ...
                <div>
                  <label className="block text-base font-semibold text-gray-800 mb-4 text-left">
                    Ideal for Ages: {eventForm.idealAges[0]} -{" "}
                    {eventForm.idealAges[1]}
                  </label>
                    ...
                    <div className="relative h-10 flex items-center">
                      ...
                      <div
                        ...
                        style={{
                          ...
                          width: `${
                            ((eventForm.idealAges[1] - eventForm.idealAges[0]) /
                              100) *
                            100
                          }%`,
                        }}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleEventChange("rsvpLink", e.target.value)
                    }
